-- apimgtdb database defination
DROP DATABASE IF EXISTS  `apimgtdb`;
CREATE SCHEMA `apimgtdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

GRANT ALL ON apimgtdb.* to apimanager@'%' IDENTIFIED BY '123456';
...
CREATE INDEX IDX_AUTHORIZATION_CODE ON IDN_OAUTH2_AUTHORIZATION_CODE (AUTHORIZATION_CODE(255),CONSUMER_KEY_ID);
