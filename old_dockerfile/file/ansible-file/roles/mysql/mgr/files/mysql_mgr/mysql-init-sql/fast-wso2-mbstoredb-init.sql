-- mbstoredb database defination
DROP DATABASE IF EXISTS  `mbstoredb`;
CREATE SCHEMA `mbstoredb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

GRANT ALL ON mbstoredb.* to apimanager@'%' IDENTIFIED BY '123456';
